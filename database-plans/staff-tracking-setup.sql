-- Add Staff Tracking and User Performance Tables
-- This script adds the necessary tables and columns to track staff assignments and performance

-- 1. Add staff assignment to orders table
ALTER TABLE orders 
ADD COLUMN staff_id UUID REFERENCES users(id) ON DELETE SET NULL,
ADD COLUMN completed_at TIMESTAMP WITH TIME ZONE,
ADD COLUMN preparation_time INTEGER, -- minutes from start to completion
ADD COLUMN started_at TIMESTAMP WITH TIME ZONE;

-- 2. Add cost tracking to menu items for profit calculations
